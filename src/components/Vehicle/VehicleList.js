...
function VehicleList(props) {
  ...
  console.log("here prosssss", props);
  ...
  const getVehicleList = (page = activePage) => {
    apiRequest(VehicleListAPI.method, VehicleListAPI.url + `?page=${page}`)
      .then((response) => {
        if (response.data.code == 200) {
      ...
      .catch((error) => {
        console.log("Failureeeeeeee", error);
        //console.log(error);
        Helper.overlay(false);
        setloader(false);
      });
  ...
  const AddWhiteLabelwithVehicle = () => {
    //setIsSoftware(null);
    let params = new FormData();
    params.append("vehicle_id", currentId);
    params.append("label_id", currentLabelId);
    //Localdispatch({ type: 'DEFAULT', payload: true})
    setloader(true);
    Helper.overlay(true);
  ...
  useEffect(() => {
    ...
    window.Echo.channel(`private-movitronic`).listen("fw_update_apply", (e) => {
      console.log("beforeEventttttttttttttttttttttttttttttt updateeeeee", e);
      if (e.data) {
        console.log("afterEvent", e);
        getVehicleList(activePage);
        setListenerEvent(e.data);
    ...
    if (props.location.hash !== "#search") {
      console.log("sdfsdfsdfsdfsdfsdfsdfsdfsd");
      getVehicleList(activePage);
  ...
  const handlePageChange = (pageNumber) => {
    ...
    apiRequest(
      VehicleListAPI.method,
      VehicleListAPI.url + `?page=${pageNumber}`
    )
      .then((response) => {
        let data = response.data;
        if (response.data.code == 200) {
                        ...
                        <div className="card card-shadow">
                            ...
                            <h5 className="card-title text-uppercase">
                              <div className="form-check">
                                <input
                                  ...
                                  name="subcheckbox"
                                  defaultValue={
                                    record.detail && record.detail.id
                                  }
                                  id="exampleCheck1"
                                />
                                <NavLink
                            ...
                            <p className="card-text">
                              ...
                              <div className="d-flex justify-content-between">
                                <div>
                                  Color:
                                  <br />
                                  <strong>{record.colour}</strong>
                                </div>
                                <div>
                                  Operator:
                                  <br />
                                  <strong>AS004850 (Private)</strong>
                                </div>
                              </div>
                          ...
                          <ul className="list-group list-group-flush">
                            <li className="list-group-item">
                              <div className="d-flex justify-content-between">
                                <div>
                                  Odometer: <br /> <strong>140 000 km</strong>
                                </div>
                                <div>
                                  Fuel level: <br />{" "}
                                  <strong>{record.fuel}%</strong>
                                </div>
                              </div>
                              ...
                              <div className="d-flex justify-content-between">
                                ...
                                <div>
                                  Car Make: <br />
                                  <strong>{record.vehicle_company_name}</strong>
                                </div>
                              </div>
                            </li>
                            <li className="list-group-item">
                            ...
                            <li className="list-group-item">
                              ...
                              <div>
                                Last usage:
                                <br /> <strong>14.12.2020 14:00, 6km</strong>
                              </div>
                              <div className="d-flex justify-content-between">
                                <div>
                                  Pevious usage:
                            ...
                            <div className="row">
                              ...
                              <div className="col-md-6">
                                {(Helper.getPermissions(
                                  ...
                                  >
                                    <button className="btn btn-info btnn-user btn-block">
                                      Edit
                                    </button>
                                  </NavLink>
                                )}
