...
var { ShareMyListAPI , deleteShare,alldeleteShare} = require("../Api/ApiRoutes");
var { apiRequest } = require("../Api/Service");


function SharesMyList() {
  ...
  React.useEffect(() => {
    ...
    Helper.overlay(true);
    setloader(true);
    apiRequest(ShareMyListAPI.method, ShareMyListAPI.url)
      .then((response) => {
  ...
  const handlePageChange = (pageNumber) => {
    ...
    apiRequest(ShareMyListAPI.method, ShareMyListAPI.url + `?page=${pageNumber}`)
      .then((response) => {
        let data = response.data;
        if (response.data.code == 200) {
          setrecords(response.data.data);
...
<div className="row">
            ...
            <div class="card card-shadow">
                        ...
                        <div class="card-body">
                          ...
                          <div className="d-flex justify-content-between">
                              <div>
                                <strong className="btn-success">Start:</strong><br/>  {record.start_date}
                              </div>
                              <div>
                              <strong>Pick-up: <br/>  Tuukri 50, Tallinn, Estonia</strong>
                              </div>
                            </div>

                            <div className="d-flex justify-content-between">
                              <div>
                                <strong className="btn-danger">Stop:</strong> <br/> {record.end_date}
                              </div>
                              <div>
